...
import questionsData from '../../dataBank/learnPython.json'
...
function LearnPython() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_learnPython')
      ...
      localStorage.setItem('quiz_learnPython', JSON.stringify({
        ...
        >
          ...
          <div className="quiz-container">
            <div className="quiz-header">
              <h2>Answer Review - Intro to Python</h2>
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Intro to Python: Grunnleggende Konsepter</h2>
          <div className="progress-info">
