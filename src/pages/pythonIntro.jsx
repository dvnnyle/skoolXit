...
import questionsData from '../../dataBank/pythonIntro.json'
import { formatExplanation } from './moduleChapters/formatExplanation'
...
function PythonIntro() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_pythonIntro')
      ...
      localStorage.setItem('quiz_pythonIntro', JSON.stringify({
          ...
          <div className="review-container">
            ...
            <div className="review-questions">
              {questions.map((question, qIndex) => {
                ...
                return (
                  <div key={qIndex} className={`review-question ${isCorrect ? 'correct-q' : 'wrong-q'}`}>
                    <div className="review-question-header">
                      <span className="review-q-number">Question {qIndex + 1}</span>
                      <span className={`review-q-badge ${isCorrect ? 'correct-badge' : 'wrong-badge'}`}>
                    ...
                    <h3 
                      ...
                      dangerouslySetInnerHTML={{ 
                        __html: formatExplanation(question.question.split('```')[0].trim()) 
                      }}
                    />

                    {question.question.includes('```python') && (
                      <div className="code-snippet-card">
                        <div className="code-header">Python</div>
                        <pre className="code-display">
                          <code>{question.question.split('```python\n')[1].split('```')[0]}</code>
                        </pre>
                      </div>
                    )}
    ...
    >
      ...
      <div className="quiz-container">
        ...
        <div className="question-card">
          ...
          {currentQuestion.question.includes('```python') && (
            <div className="code-snippet-card">
              <div className="code-header">Python</div>
              <pre className="code-display">
                <code>{currentQuestion.question.split('```python\n')[1].split('```')[0]}</code>
              </pre>
            </div>
          )}
