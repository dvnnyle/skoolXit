...
function Module4b() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module4b')
      ...
      localStorage.setItem('quiz_module4b', JSON.stringify({
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 4B: Styring, kontroll og fremdrift</h2>
          <div className="progress-info">
