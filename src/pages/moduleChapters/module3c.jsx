...
import questionsData from '../../../dataBank/modul3c.json'
import './modules.css'
...
function Module3c() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module3c')
      ...
      localStorage.setItem('quiz_module3c', JSON.stringify({
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 3C: Prosjektavslutning og gevinstrealisering</h2>
          <div className="progress-info">
