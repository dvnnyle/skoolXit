...
import questionsData from '../../../dataBank/modul2b.json'
...
function Module2b() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module2b')
      ...
      localStorage.setItem('quiz_module2b', JSON.stringify({
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 2B: Relasjonsbygging</h2>
          <div className="progress-info">
