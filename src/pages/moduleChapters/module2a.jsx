...
import questionsData from '../../../dataBank/modul2a.json'
...
function Module2a() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questions.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module2a')
      ...
      localStorage.setItem('quiz_module2a', JSON.stringify({
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 2A: Kommunikasjon i grupper</h2>
          <div className="progress-info">
