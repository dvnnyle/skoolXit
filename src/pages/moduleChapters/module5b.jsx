...
import questionsData from '../../../dataBank/modul5b.json'
import './modules.css'
...
function Module5b() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module5b')
      ...
      localStorage.setItem('quiz_module5b', JSON.stringify({
        score: finalScore,
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 5B: Psykologiske aspekter ved konflikter</h2>
          <div className="progress-info">
