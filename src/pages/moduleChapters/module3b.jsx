...
import questionsData from '../../../dataBank/modul3b.json'
import './modules.css'
...
function Module3b() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module3b')
      ...
      localStorage.setItem('quiz_module3b', JSON.stringify({
        score: finalScore,
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 3B: Læring og kunnskapsdeling i prosjekter</h2>
          <div className="progress-info">
