...
import questionsData from '../../../dataBank/modul3a.json'
...
function Module3a() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module3a')
      ...
      localStorage.setItem('quiz_module3a', JSON.stringify({
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 3A: Arbeid i profesjonelle team og aksjonslæring</h2>
          <div className="progress-info">
