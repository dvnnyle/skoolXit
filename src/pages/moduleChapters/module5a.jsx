...
import questionsData from '../../../dataBank/modul5a.json'
import './modules.css'
...
function Module5a() {
  ...
  const handleNext = () => {
    if (currentQuestionIndex < questionsData.length - 1) {
      ...
      const existingData = localStorage.getItem('quiz_module5a')
      ...
      localStorage.setItem('quiz_module5a', JSON.stringify({
  ...
  return (
    ...
    >
      ...
      <div className="quiz-container">
        <div className="quiz-header">
          <h2>Module 5A: Konflikter i prosjekter</h2>
          <div className="progress-info">
